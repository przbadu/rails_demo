...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { balance: @wallet.balance, color: @wallet.color, deleted_at: @wallet.deleted_at, icon: @wallet.icon, name: @wallet.name } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { balance: @wallet.balance, color: @wallet.color, deleted_at: @wallet.deleted_at, icon: @wallet.icon, name: @wallet.name } }
